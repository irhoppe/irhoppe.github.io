...
```{r fig.cap="Mallee woodlands of Brookfield under the dull sienna sky of a late-spring dust storm."}
knitr::include_graphics("https://res.cloudinary.com/sternula/image/upload/v1659860962/mallee_pmr4h3.jpg")
```
...
```{r fig.cap="Prevalence of haemosporidian infections among 8 bird species at Brookfield Conservation Park."}
knitr::include_graphics("https://res.cloudinary.com/sternula/image/upload/v1659861831/prev-fig_poster_kegium.png")
```
